    ...
    public partial class Tedarikçiler : Form
    {
        ...
        public void kaydet()
        {
            if (txt_firmaAdi.Text != "" && txt_firmaYetkilisi.Text != "")
            {
                ...
                kaydet.Parameters.Add("@telefonNumarası", SqlDbType.NVarChar, 11).Value = txt_telNo.Text;
        ...
        private void btn_guncelle_Click(object sender, EventArgs e)
        {
            if (txt_firmaAdi.Text != "" && txt_firmaYetkilisi.Text != "")
            {
                ...
                guncellekomutu.Parameters.Add("@telefonNumarası", SqlDbType.NVarChar, 11).Value = txt_telNo.Text;
